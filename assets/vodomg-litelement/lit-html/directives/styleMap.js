/// BareSpecifier=vodomg-litelement/lit-html/directives/styleMap
/// BareSpecifier=lit-html/directives/styleMap
/**
 * @license
...
export const styleMap = styleInfo => directive(part => {
    ...
    for (const name in oldInfo) {
        if (!(name in styleInfo)) {
            part.committer.element.style[name] = null;
        }
    }
    Object.assign(part.committer.element.style, styleInfo);
