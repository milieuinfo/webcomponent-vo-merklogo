/// BareSpecifier=@polymer/lit-element/test/lit-element_test
/// BareSpecifier=@polymer/lit-element/test/lit-element_test
/**
 * @license
...
suite('LitElement', () => {
    ...
    test('property options via decorator', async () => {
        ...
        __decorate([property({ attribute: false })], E.prototype, "noAttr", void 0);
        __decorate([property({ attribute: true })], E.prototype, "atTr", void 0);
        __decorate([property({ attribute: 'custom', reflect: true })], E.prototype, "customAttr", void 0);
        __decorate([property({ hasChanged })], E.prototype, "hasChanged", void 0);
        __decorate([property({ type: fromAttribute })], E.prototype, "fromAttribute", void 0);
        __decorate([property({ reflect: true, type: { toAttribute } })], E.prototype, "toAttribute", void 0);
        __decorate([property({
            attribute: 'all-attr',
            hasChanged,
            type: { fromAttribute, toAttribute },
    ...
    test('`firstUpdated` called when element first updates', async () => {
        ...
        __decorate([property()], E.prototype, "foo", void 0);
        customElements.define(generateElementName(), E);
        const el = new E();
        container.appendChild(el);
        await el.updateComplete;
