/// BareSpecifier=lit-html-element/src/lit-element
...
function attachProperty(prototype, propertyName, options) {
    ...
    function get() {
        return this.__values__[propertyName];
    }
    function set(v) {
        // @ts-ignore
...
export class LitElement extends HTMLElement {
    ...
    static get observedAttributes() {
        return Object.keys(this.properties).map(key => this.properties[key].attrName).filter(name => name);
    }
