/// BareSpecifier=@polymer/lit-element/test/lib/decorators_test
/**
 * @license
...
suite('decorators', () => {
    ...
    suite('@customElement', () => {
        test('defines an element', () => {
            ...
            C0 = __decorate([customElement(tagName)], C0);
    ...
    suite('@query', () => {
        ...
        __decorate([query('#blah')], C.prototype, "blah", void 0);
        __decorate([query('span')], C.prototype, "nope", void 0);
    ...
    suite('@queryAll', () => {
        ...
        __decorate([queryAll('div')], C.prototype, "divs", void 0);
        __decorate([queryAll('span')], C.prototype, "spans", void 0);
        C = __decorate([customElement(generateElementName())], C);
